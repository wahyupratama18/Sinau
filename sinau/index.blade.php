...
<html lang="en">
    ...
    <body>
        <nav id="navbar_top" class="navbar navbar-expand-lg fixed-top navbar-light">
            <a class="navbar-brand font-weight-bold" href="index.html">Gancang Pinter</a>
            <button
            ...
            <div class="collapse navbar-collapse float-right" id="navbarNav">
                <div class="col-sm ml-4 p-2">
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link font-weight-light" href="about.html">Tentang Kami</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link font-weight-light" href="guru.html">Guru</a>
                        </li>
                    </ul>
                </div>
            </div>
