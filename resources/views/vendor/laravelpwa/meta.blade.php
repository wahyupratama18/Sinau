...
<link href="{{ $splash }}" media="(device-width: {{ explode('x', $key)[0] }}px) and (device-height: {{ explode('x', $key)[1] }}px) and (-webkit-device-pixel-ratio: 2)" rel="apple-touch-startup-image" />
@endforeach
